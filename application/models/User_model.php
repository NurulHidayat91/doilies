...
class User_model extends CI_Model
{
    ...
    function json()
    {
        $this->datatables->select('id_users,full_name,username,email,nama_level,is_aktif,nik,jabatan, divisi');
        ...
        $this->datatables->join('jabatan', 'tbl_user.id_jabatan = jabatan.id_jabatan');
        $this->datatables->join('divisi', 'tbl_user.id_divisi = divisi.id_divisi');
    ...
    function get_email_user($id, $password)
    {
