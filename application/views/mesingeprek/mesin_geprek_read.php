...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Mesin_geprek Read</h2>
        <table class="table">
	    <tr><td>No Wo</td><td><?php echo $no_wo; ?></td></tr>
	    <tr><td>Id User</td><td><?php echo $id_user; ?></td></tr>
	    <tr><td>Operator2</td><td><?php echo $operator2; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('mesingeprek') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>