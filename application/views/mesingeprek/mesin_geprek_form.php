		...
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<?php if ($button === "Update") { ?>
					<h3 class="box-title">UPDATE DATA MESIN KEPREK</h3>
				<?php } elseif ($button === "Repeat") { ?>
					<h3 class="box-title">REPEAT DATA MESIN KEPREK</h3>
				<?php } else { ?>
					<h3 class="box-title">INPUT DATA MESIN KEPREK</h3>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>'>
					...
					<tr>
						<td width='200'>Operator 1 <?php echo form_error('id_user') ?></td>
						<td><input type="text" class="form-control" name="id_user" id="id_user" readonly placeholder="Operator1" value="<?php echo $this->session->full_name ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Operator 2 <?php echo form_error('operator2') ?></td>
						<td><input type="text" class="form-control" name="operator2" id="operator2" placeholder="Operator2 (Optional)" value="<?php echo $operator2; ?>" /></td>
					</tr>
					...
					<?php if ($button === "Update") { ?>
						<tr>
							...
							<td>
								...
								<!-- <input type="text" readonly class="form-control" name="id_customer" id="id_customer" placeholder="Id Member" value="<?php echo $id_customer; ?>" /> -->
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<!-- <?php echo datalist_dinamis('id_customer', 'customer', 'nama_customer', $id_customer) ?> -->
								<input type="text" readonly class="form-control" name="id_customer" id="id_customer" placeholder="Member" value="<?php echo $id_customer; ?>" />
							</td>
						</tr>
					...
					<!-- <tr>
						<td width='200'>Hasil Dari Potongan <?php echo form_error('hasil_potongan') ?></td>
						<td><input type="text" readonly class="form-control" name="hasil_potongan" id="hasil_potongan" placeholder="Hasil potongan" /></td>
					</tr> -->
					<tr>
						<td width='200'>Broke <?php echo form_error('rejected') ?></td>
						<td><input type="text" class="form-control" name="rejected" id="rejected" placeholder="Isikan 0 " value="<?php echo $rejected; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_mesin_geprek" value="<?php echo $id_mesin_geprek; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('mesingeprek') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
...
<script type="text/javascript">
	function autoFill() {
		...
		$.ajax({
			url: "<?= base_url() ?>mesingeprek/autofill",
			type: "GET",
			data: {
				'no_wo': no_wo
			},
