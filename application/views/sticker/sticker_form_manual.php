		...
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<?php if ($button === "Update") { ?>
					<h3 class="box-title">UPDATE DATA STICKER</h3>
				<?php } elseif ($button === "Repeat") { ?>
					<h3 class="box-title">REPEAT DATA STICKER</h3>
				<?php } else { ?>
					<h3 class="box-title">INPUT DATA STICKER</h3>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>'>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_sticker" value="<?php echo $id_sticker; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('sticker') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
