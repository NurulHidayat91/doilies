		...
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<?php if ($button === "Update") { ?>
					<h3 class="box-title">UPDATE DATA PACKING BOX</h3>
				<?php } elseif ($button === "Repeat") { ?>
					<h3 class="box-title">REPEAT DATA PACKING BOX</h3>
				<?php } else { ?>
					<h3 class="box-title">INPUT DATA PACKING BOX</h3>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>'>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="rejected" id="rejected" placeholder="Isikan angka 0 jika kosong" value="<?php echo $rejected; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control" readonly name="persentase" id="persentase" placeholder="persentase" value="<?php echo $persentase; ?>" /></td>
					</tr>


					<tr>
						<td></td>
						<td><input type="hidden" name="id_packingbox" value="<?php echo $id_packingbox; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('packingbox') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
...
<script type="text/javascript">
	function autoFill() {
		...
		$.ajax({
			url: "<?= base_url() ?>packingbox/autofill",
			type: "GET",
			data: {
				'no_wo': no_wo
			},
