		...
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<?php if ($button === "Update") { ?>
					<h3 class="box-title">UPDATE DATA POTONGAN</h3>
				<?php } elseif ($button === "Repeat") { ?>
					<h3 class="box-title">REPEAT DATA POTONGAN</h3>
				<?php } else { ?>
					<h3 class="box-title">INPUT DATA POTONGAN</h3>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>'>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="no_wo" id="no_wo" onkeyup="autoFill()" placeholder="No Wo" value="<?php echo $no_wo; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Operator <?php echo form_error('id_user') ?></td>
						<td>
							<input type="text" class="form-control" name="id_user" id="id_user" placeholder="Masukkan operator" readonly value="<?php echo $this->session->full_name ?>" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<!-- <input type="text" class="form-control" name="id_waktu" id="id_waktu" placeholder="Waktu" value="<?php echo $id_waktu; ?>" /> -->
						</td>
					</tr>
					<tr>
					...
					<?php if ($button === 'Update') { ?>
						...
						<tr>
							...
							<td>
								...
								<!-- <input type="text" class="form-control" name="id_customer" id="id_customer" placeholder="Masukkan Customer" value="<?php echo $id_customer; ?>" /> -->
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<!-- <input type="text" class="form-control" name="id_warna" id="id_warna" placeholder="Masukin Warna" value="<?php echo $id_warna; ?>" /> -->
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<!-- <input type="text" class="form-control" onkeyup="autoFill()" name="id_bentuk" id="id_bentuk" placeholder="Id Bentuk" value="<?php echo $id_bentuk; ?>" /> -->
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<!-- <input type="text" class="form-control" name="id_lembar" id="id_lembar" placeholder="Masukkan Lembar" value="<?php echo $id_lembar; ?>" /> -->
							</td>
						</tr>
					<?php } else { ?>
						...
						<tr>
							...
							<td>
								<!-- <?= cmb_dinamis('id_warna', 'warna', 'warna', 'id_warna', $id_warna) ?> -->
								<input type="text" readonly class="form-control" name="id_warna" id="id_warna" placeholder="Masukin Warna" value="<?php echo $id_warna; ?>" />
							</td>
						</tr>
						<tr>
							<td width='200'>Bentuk <?php echo form_error('id_bentuk') ?></td>
							<td>
								...
								<input type="text" readonly class="form-control" onkeyup="autoFill()" name="id_bentuk" id="id_bentuk" placeholder="Id Bentuk" value="<?php echo $id_bentuk; ?>" />
							</td>
						</tr>
						<tr>
							<td width='200'>Ukuran <?php echo form_error('id_ukuran') ?></td>
							<td>
								<!-- <?= cmb_dinamis('id_ukuran', 'ukuran', 'ukuran', 'id_ukuran', $id_ukuran) ?> -->
								<input type="text" readonly class="form-control" name="id_ukuran" id="id_ukuran" placeholder="Id Ukuran" value="<?php echo $id_ukuran; ?>" />
							</td>
						</tr>
						<tr>
							<td width='200'>Lembar <?php echo form_error('id_lembar') ?></td>
							<td>
								...
								<input type="text" readonly class="form-control" name="id_lembar" id="id_lembar" placeholder="Masukkan Lembar" value="<?php echo $id_lembar; ?>" />
							</td>
						</tr>
					<?php } ?>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="rejected" id="rejected" placeholder="Isikan angka 0" value="<?php echo $rejected; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_potongan" value="<?php echo $id_potongan; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('potongan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
...
<script type="text/javascript">
	...
	// 		source: "<?php echo base_url() ?>/potongan/autocomplate_operator",
	// 		minLength: 1
	// 	});
	// });
	...
	// 	console.log(no_wo);
	// 	$.ajax({
	// 		url: "<?= base_url() ?>potongan/autofill",
	// 		type: "GET",
	// 		data: {
	// 			'no_wo': no_wo
	// 		},
