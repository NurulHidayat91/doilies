		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Lebar Bahan <?php echo form_error('lebar_roll') ?></td>
						<td><input type="text" class="form-control" name="lebar_roll" id="lebar_roll" placeholder="Lebar Roll" value="<?php echo $lebar_roll; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Panjang Pot <?php echo form_error('panjang_pot') ?></td>
						<td><input type="text" class="form-control" name="panjang_pot" id="panjang_pot" placeholder="Panjang Pot" value="<?php echo $panjang_pot; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td width='200'>Target Mesin <?php echo form_error('targetMesin') ?></td>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_targetMesin" value="<?php echo $id_targetMesin; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('targetmesin') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
