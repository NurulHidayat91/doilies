					...
					<div class="box box-warning box-solid">
						<div class="box-header with-border">
							<?php if ($button === 'Create') { ?>
								<h3 class="box-title">INPUT DATA OPERATOR MESIN</h3>
							<?php } elseif ($button === 'Update') { ?>
								<h3 class="box-title">UPDATE DATA OPERATOR MESIN</h3>
							<?php } else { ?>
								<h3 class="box-title">REPEAT DATA OPERATOR MESIN</h3>
							<?php } ?>
						</div>
						<form action="<?php echo $action; ?>" method="post">
							...
							<table class='table table-bordered>'>
								...
								<tr>
									...
									<td>
										<input type="text" readonly class="form-control" name="no_form" id="no_form" value="form standard" />
								...
								<tr>
									...
									<td>
										<?php
										if ($button === 'Create') { ?>
											<input type="text" class="form-control" readonly name="id_gsm" id="id_gsm" placeholder="Gsm" value="<?php echo $id_gsm; ?>" />

										<?php } else { ?>
											<input type="text" class="form-control" readonly name="id_gsm" id="id_gsm" placeholder="Gsm" value="<?php echo $id_gsm == $row->id_gsm ? $row->gsm : null; ?>" />
										<?php } ?>
									</td>
								</tr>
								...
								<tr>
									<td width='200'>Lebar(cm) <?php echo form_error('lebar') ?></td>
									<td>
										<input type="text" readonly class="form-control" name="lebar" id="lebar" placeholder="Lebar" value="<?php echo $lebar; ?>" />
									</td>
								</tr>
								<tr>
...
<script type="text/javascript">
	$(document).ready(function() {
		function getValueId() {
			...
			$.ajax({
				url: "<?= base_url() ?>operatormesin/autofill",
				type: "POST",
				data: {
					'id_lembar': lembar,
					'id_ukuran': ukuran,
		...
		$(document).on('change keyup', '#id_lembar, #id_ukuran, #id_grade, #id_warna', function() {
			getValueId()
