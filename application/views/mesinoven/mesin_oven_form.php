		...
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<?php if ($button === "Update") { ?>
					<h3 class="box-title">UPDATE DATA MESIN OVEN</h3>
				<?php } elseif ($button === "Repeat") { ?>
					<h3 class="box-title">REPEAT DATA MESIN OVEN</h3>
				<?php } else { ?>
					<h3 class="box-title">INPUT DATA MESIN OVEN</h3>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered>'>
					...
					<tr>
						...
						<td><input type="text" class="form-control" readonly name="id_user" id="id_user" placeholder="Id User" value="<?php echo $this->session->full_name ?>" /></td>
					</tr>

					<tr>
						<td width='200'>Operator 2 <?php echo form_error('operator2') ?></td>
						<td><input type="text" class="form-control" name="operator2" id="operator2" placeholder="Operator2" value="<?php echo $this->session->operator2 ?>" /></td>
					</tr>
					...
					<tr>
						<td width='200'>Suhu <?php echo form_error('speed') ?></td>
						<td><input type="text" class="form-control" name="speed" id="speed" placeholder="Masukkan suhu" value="<?php echo $speed; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="rejected" id="rejected" placeholder="Rejected" value="<?php echo $rejected; ?>" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><input type="hidden" name="id_mesin_oven" value="<?php echo $id_mesin_oven; ?>" />
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>
							<a href="<?php echo site_url('mesinoven') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
