...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Mesin_oven Read</h2>
        <table class="table">
	    ...
	    <tr><td>Speed</td><td><?php echo $speed; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('mesinoven') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>