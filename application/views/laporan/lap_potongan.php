        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">LAPORAN PROSES POTONGAN</h3>
                    </div>
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-bordered" style="margin-bottom: 10px">
                            ...
                            <tbody>
                                ...
                                foreach ($row->result() as $potongan) {
                                    (int)$totalHasil += (int)$potongan->hasil
                                ?>
                                    <tr>
                ...
                <div class="card-footer clearfix">
                    <a class="btn btn-success" href="<?= base_url() . 'laporan/export_excel_potongan' ?>">Export Excel</a>
                </div>
            </div>
        </div>
    </section>
